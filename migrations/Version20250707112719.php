 ...
 */
final class Version20250707112719 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , password VARCHAR(255) NOT NULL, is_blocked BOOLEAN NOT NULL)');
